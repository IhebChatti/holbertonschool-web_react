...
describe("With CourseList containing elements", () => {
  ...
  it("renders a <CourseList /> component and verifies 5 rows", () => {
    ...
    expect(wrapperTwo.find(CourseListRow).get(0).props.textFirstCell).toEqual(
      "Available courses"
    );
    expect(wrapperTwo.find(CourseListRow).get(0).props.isHeader).toBe(true);
    expect(wrapperTwo.find(CourseListRow).get(1).props.textFirstCell).toEqual(
      "Course name"
    );
    expect(wrapperTwo.find(CourseListRow).get(1).props.textSecondCell).toEqual(
      "Credit"
    );
    expect(wrapperTwo.find(CourseListRow).get(1).props.isHeader).toBe(true);
    expect(wrapperTwo.find(CourseListRow).get(2).props.textFirstCell).toEqual(
      "ES6"
    );
    expect(wrapperTwo.find(CourseListRow).get(2).props.textSecondCell).toEqual(
      60
    );
    expect(wrapperTwo.find(CourseListRow).get(2).props.isHeader).toBe(false);
    expect(wrapperTwo.find(CourseListRow).get(3).props.textFirstCell).toEqual(
      "Webpack"
    );
    expect(wrapperTwo.find(CourseListRow).get(3).props.textSecondCell).toEqual(
      20
    );
    expect(wrapperTwo.find(CourseListRow).get(3).props.isHeader).toBe(false);
    expect(wrapperTwo.find(CourseListRow).get(4).props.textFirstCell).toEqual(
      "React"
    );
    expect(wrapperTwo.find(CourseListRow).get(4).props.textSecondCell).toEqual(
      40
    );
  ...
  it("verifies that when you pass a list of courses, the component renders it correctly", () => {
    ...
    expect(wrapperThree.find(CourseListRow).get(0).props.textFirstCell).toEqual(
      "Available courses"
    );
    expect(wrapperThree.find(CourseListRow).get(0).props.isHeader).toBe(true);
    expect(wrapperThree.find(CourseListRow).get(1).props.textFirstCell).toEqual(
      "Course name"
    );
    expect(
      wrapperThree.find(CourseListRow).get(1).props.textSecondCell
    ).toEqual("Credit");
    expect(wrapperThree.find(CourseListRow).get(1).props.isHeader).toBe(true);
    expect(wrapperThree.find(CourseListRow).get(2).props.textFirstCell).toEqual(
      "C"
    );
    expect(
      wrapperThree.find(CourseListRow).get(2).props.textSecondCell
    ).toEqual(65);
    expect(wrapperThree.find(CourseListRow).get(2).props.isHeader).toBe(false);
    expect(wrapperThree.find(CourseListRow).get(3).props.textFirstCell).toEqual(
      "Python"
    );
    expect(
      wrapperThree.find(CourseListRow).get(3).props.textSecondCell
    ).toEqual(22);
    expect(wrapperThree.find(CourseListRow).get(3).props.isHeader).toBe(false);
    expect(wrapperThree.find(CourseListRow).get(4).props.textFirstCell).toEqual(
      "JS"
    );
    expect(
      wrapperThree.find(CourseListRow).get(4).props.textSecondCell
    ).toEqual(13);
